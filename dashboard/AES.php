<?php
	...
	class AES {
		...
		# funngsi yang berhubungan yaitu addRoundKey(), subByte(), ShiftRow(), MixColumns()
		...
		# fungsi untuk menggabungkan DATA dengan KUNCI
		...
		# fungsi untuk melakukan Generate Key
		function keyexpansion($key){
		
			# membagi String menjadi Array per karakter
